  ...
  return (
    ...
    >
      <div className={classNames("flex flex-row flex-1", "relative")}>
          ...
          <div className="flex flex-col h-full p-16">
            <div className="tracking-tight mb-8">
              <p className="mb-2 font-medium text-gray-400">
                <span className="uppercase">{APP_CONFIG.quizInfo.author}</span>{" "}
                presents
              </p>
        ...
        <div className={classNames("w-full", "bg-gray-200")}>
          <div className="flex flex-col h-full p-16">content...</div>
        </div>
      </div>
    </section>
  );
